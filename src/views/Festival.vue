    ...
    >
      <div class="mt-9 ml-5 mr-5 p-2">
        ...
        <p class="bg-white">
          ...
          président Théo Pasquarelli. Un festival 100% RAP francophone et autre
          lors duquel vous pourrez retrouver vos rappeurs préférés interpréter
          leurs plus grands morceaux. Une première édition qui arrive en force
          et qui, on l'espère, ne sera pas la dernière !
        </p>
      </div>
      <img
        src="../../public/img/damso_festival.jpg"
      ...
      <div class="mt-9 ml-5 mr-5 p-2">
        ...
        <p class="bg-white">
          ...
          minuit. Les artistes se produiront sur 2 scènes différentes, la Petite
          scène et le Gra de scène, en simultané et il se pourrait que certains
          artistes se croisent sur scène... Des stands et foodtrucks seront
          présent pour votre plus grand plaisir, ainsi que de nombreuses
          animations et démonstration (danse, freestyle, etc ...)
        </p>
      </div>
      <img
        src="../../public/img/hanny-naibaho-aWXVxy8BSzc-unsplash.jpg"
        class="p-5 mt-5 md:h-64 md:w-screen md:object-cover lg:h-60 lg:w-screen lg:object-cover"
      />
    </div>
  </div>
</template>
